      ...
      <div className="proj-sum">
        <div className="proj-sum-header">
          <div className="proj-sum-img-div">
            <a href="https://sogalutira.github.io/my-lit-keyboard/"><img className="proj-sum-img" src="https://github.com/sogalutira/my-portfolio/blob/master/src/assets/ffxivcrafting.png?raw=true"></img></a>
          </div>
